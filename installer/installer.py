...
class InstallerWizard(QWidget):
    ...
    def confirm_installation(self):
        ...
        # Controllo semplice presenza file/cartelle comuni Valkyria Chronicles
        ...
        if not found and os.path.exists(dest_path): warn_msg="<b>Attenzione:</b> La cartella non sembra contenere Valkyria Chronicles."; warn_icon=self.style().standardIcon(QStyle.StandardPixmap.SP_MessageBoxWarning); icon_pixmap=warn_icon.pixmap(QSize(48,48))
